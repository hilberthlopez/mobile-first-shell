...
export const Route = createFileRoute("/rutas")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Planificación y gestión de rutas." },
      { property: "og:title", content: "Gestión de Ruta — CarteraApp" },
      { property: "og:description", content: "Planificación y gestión de rutas." },
    ],
  }),
  component: Rutas,
});
    ...
    <AppLayout>
      <div className="mx-auto w-full max-w-6xl p-4 sm:p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Planifica y organiza las rutas de visita.
        </p>
      </div>
    </AppLayout>
  );
